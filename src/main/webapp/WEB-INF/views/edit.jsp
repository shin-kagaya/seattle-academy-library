...
  </header>
  <main>
    <form action="<%=request.getContextPath()%>/editsBook" method="post" enctype="multipart/form-data" id="data_upload_form">
        <h1>書籍の編集</h1>
            <div class="content_body add_book_content">
                ...
                <div class="content_right">
                    ...
                    <div>
                        ...
                        <c:if test="${!empty bookEditInfo}">
                            <input type="text" name="publishDate" value="${bookEditInfo.publishDate}">
                        </c:if>
                        <c:if test="${empty bookEditInfo}">
                    ...
                    <div>
                        ...
                        <c:if test="${!empty bookEditInfo}">
                            <input type="text" name="description" value="${bookEditInfo.description}">
                        </c:if>
                        <c:if test="${empty bookEditInfo}">
