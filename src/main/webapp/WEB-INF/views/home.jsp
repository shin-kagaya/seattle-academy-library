...
<body class="wrapper">
    ...
    <main>
        ...
        <ul class="podition">
            <li>
                <input type="radio" name="searchColumn" value="title" checked> 書籍名 <input type="radio" name="searchColumn" value="author"> 著者名
            </li>
            <li>
                <input type="radio" name="searchStyle" value="part" checked> 部分一致 <input type="radio" name="searchStyle" value="perfect"> 完全一致
            </li>
        </ul>    
